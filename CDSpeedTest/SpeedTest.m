...
NSManagedObjectModel *managedObjectModel(NSString *name) 
{    
	NSString *path = [NSString stringWithFormat:@"%@.mom", name];;
...
NSManagedObjectContext *managedObjectContext(NSString *name) {
    ...
    NSManagedObjectModel *model = managedObjectModel(name);
    ...
    NSString *path = [NSString stringWithFormat:@"/tmp/%@.sql", name];
